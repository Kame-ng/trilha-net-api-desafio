...
using Microsoft.EntityFrameworkCore; // Importante para operações com EF
...
namespace TrilhaApiDesafio.Controllers
{
    ...
    public class TarefaController : ControllerBase
    {
        ...
        {
            // Buscar as tarefas no banco que contenha o título recebido por parâmetro
        ...
        {
            // Buscar as tarefas no banco que contenha o status recebido por parâmetro
